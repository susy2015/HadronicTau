...
Transfer_Input_Files = $ENV(CMSSW_BASE)/src/HadronicTau/Tool/HadTauLL, $ENV(CMSSW_BASE)/src/HadronicTau/Tool/condorHadTauLL/goMakePlots.sh, $ENV(CMSSW_BASE)/lib/$ENV(SCRAM_ARCH)/librecipeAUXOxbridgeMT2.so, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/TopTagger_Simplified.cfg, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/TopTagger.cfg, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/TrainingOutput_dR20_pt30_depth12_500tree_2017_Feb16.model, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/TrainingOutput_dR20_pt30_depth12_500tree_noQGL_binaryCSV_2017_Mar24.model, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/CSVFiles/CSVv2_Moriond17_B_H.csv, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/data/allINone_bTagEff.root, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/ISR_Root_Files/allINone_ISRJets.root, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/ISR_Root_Files/ISRWeights.root, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/LeptonSF_Root_Files/allINone_leptonSF_Moriond17.root, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/data/puppiCorr.root, $ENV(CMSSW_BASE)/src/SusyAnaTools/Tools/data/PileupHistograms_0121_69p2mb_pm4p6.root, TRANS_TAR_BALL_CMSSW
